    ...
    public partial class OrderEntityAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkinetUser", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Address_SkinetUser_SkinetUserId",
                        column: x => x.SkinetUserId,
                        principalTable: "SkinetUser",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkinetUser_Email",
                table: "SkinetUser",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SkinetUser_UserName",
                table: "SkinetUser",
                column: "UserName",
                unique: true);
        }
